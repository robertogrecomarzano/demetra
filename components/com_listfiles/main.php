...
class ListFiles extends Plugin
{
    ...
    {
        $files = [];
        foreach (glob(Config::$serverRoot . DS . "public" . DS .  $this->folder . DS . $this->directory . "/*" . $this->extension) as $filename) {
    ...
    function show()
    {
        ...
        foreach ($this->files as $file) {
            $out .= "<a target='_blank' href=" . Config::$urlRoot . "/core/download.php?doc=" . $this->folder . "/" . $this->directory . "/" . $file["filename"] . "&t=$this->downloadType class='list-group-item'>";
