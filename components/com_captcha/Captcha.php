...
class Captcha extends Plugin
{
    ...
    function Draw()
    {
        ...
        $reload = '<i class="fas fa-refresh"></i>';
        $linkArgs = array(
            "href" => "javascript:reloadCaptcha()"
        );
        $link = HTML::tag("a", $linkArgs, $reload);
        ...
        $txt = Form::textbox(array(
            ...
            "required" => "",
            "oninvalid" => "this.setCustomValidity('Codice captcha obbligatorio')"
        ), null);
        return "<div class=\"form-group\">$link$img</div><div class=\"form-group input-group\"><span class=\"input-group-addon\"><i class='fas fa-shield-alt'></i></span>$txt</div>";
    }
