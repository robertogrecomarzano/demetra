...
class PdfUtility
{
    ...
    static function creaDupliceCopiaPdf($file)
    {
        ...
        $filenameCopia = $dirname . DS . basename($file, '.pdf') . ".copia.pdf";

        $filenameDupliceCopia = $dirname . DS . basename($file, '.pdf') . ".duplice.pdf";
        ...
        copy($file, $dirname . DS . basename($file, '.pdf') . ".copia.pdf");

        $mpdf->Output($filenameDupliceCopia);
