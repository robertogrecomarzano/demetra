...
{form_opening class="form form-horizontal"}
	...
	<div class="form-group">
		...
		<div class="col-md-6 col-sm-6 col-xs-12">{form_tbox iname="destinatario" size="50" max="100" value="Destinatario"}</div>
	</div>
	<div class="form-group">
	...
	<div class="form-group">
		...
		<div class="col-md-6 col-sm-6 col-xs-12">{form_tbox iname="oggetto" size="50" max="100" value="Test email"}</div>
	</div>
	<div class="form-group">
		<label class="control-label col-md-6 col-sm-6 col-xs-12">Testo del messaggio</label>
		<div class="col-md-6 col-sm-6 col-xs-12">{form_tbox iname="messaggio" size="50" max="100" value="Testo di prova della mail"}</div>
	</div>
